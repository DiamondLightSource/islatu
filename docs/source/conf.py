...
latex_documents = [
    (master_doc, "islatu.tex", "islatu Documentation", "Philip Mousley", "manual"),
]
...
man_pages = [(master_doc, "islatu", "islatu Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "islatu",
        "islatu Documentation",
        author,
        "islatu",
        "X-ray reflectometry reduction.",
        "Miscellaneous",
    ),
]
