...
.. py:class:: Profile(data: islatu.data.Data, scans: list[islatu.scan.Scan])
   ...
   .. py:method:: fromfilenames(filenames, parser, adjustments=None)
      :canonical: refl_profile.Profile.fromfilenames
      :classmethod:

      .. autodoc2-docstring:: refl_profile.Profile.fromfilenames

   .. py:method:: bkg_sub_and_crop(crop_function, crop_kwargs, bkg_sub_function, bkg_kwargs)
      :canonical: refl_profile.Profile.bkg_sub_and_crop

      .. autodoc2-docstring:: refl_profile.Profile.bkg_sub_and_crop
